  ...
  group('Gastos: ', () {
    ...
    blocTest<VehiculoBloc, VehiculoEstado>(
      ...
      expect: () => <VehiculoEstado>[
        ...
        MisGastos(misGastos: Gastos().fetchAllWithFilters([1], DateTime.now(), DateTime.now()), fechaFinal: DateTime.now(), fechaInicial: DateTime.now(), misEtiquetas: Etiquetas().fetchAll(), filtroIdEtiqueta: 0),
      ],
    );
     blocTest<VehiculoBloc, VehiculoEstado>(
